      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            ...
            >
              {/* Logo glow */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/30 to-yellow-500/30 rounded-[20px] blur-xl" />
              
              <div className="relative w-20 h-20 bg-gradient-to-br from-[#D4AF37] to-[#B8940E] rounded-[20px] shadow-2xl flex items-center justify-center">
          ...
          >
            {/* Button glow */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#D4AF37]/30 to-[#C8A86A]/30 rounded-[20px] blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
