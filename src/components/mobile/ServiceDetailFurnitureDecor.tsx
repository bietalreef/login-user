...
import { ArrowRight, Star, Sofa, Sparkles, Lightbulb, Paintbrush, Award, Home as HomeIcon, Briefcase, Monitor } from 'lucide-react';
...
export function ServiceDetailFurnitureDecor({ onBack, onNavigate, onOpenSearch, onOpenDrawer }: ServiceDetailFurnitureDecorProps) {
  ...
  const serviceItems = [
    ...
    { icon: Sparkles, theme: 'cyan', title: t('furnitureServices.plants'), description: t('furnitureServices.plantsDesc') },
