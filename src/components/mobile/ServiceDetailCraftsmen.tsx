...
export function ServiceDetailCraftsmen({ onBack, onNavigate, onOpenSearch }: ServiceDetailCraftsmenProps) {
  ...
  const serviceItems = [
    ...
    { icon: Wrench, theme: 'violet', title: t('craftsmenServices.generalMaint'), description: t('craftsmenServices.generalMaintDesc') },
    { icon: Sparkles, theme: 'pink', title: t('craftsmenServices.cleaning'), description: t('craftsmenServices.cleaningDesc') },
