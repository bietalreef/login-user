// Script to replace all figma:asset imports in SEO files
...
console.log('Asset replacement map created');
console.log(`Total assets to replace: ${Object.keys(replacements).length}`);
